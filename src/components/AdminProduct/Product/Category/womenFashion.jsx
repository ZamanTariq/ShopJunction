...
export default class womenFashion extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentWillMount() {
    fetch("http://localhost:5000/adminproduct/category/women-fashion")
  ...
  render() {
    ...
    return (
      <div className="container-fluid">
        ...
        {Title (<MDBIcon icon="fas fa-female"  />,"Women ", "Fashions")}
          <input
