...
export default class menFashion extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentWillMount() {
    fetch("http://localhost:5000/adminproduct/category/automotive-motorbike")
  ...
  render() {
    ...
    return (
      <div className="container-fluid">
        ...
        {Title (<MDBIcon icon="fas fa-motorcycle"  />,"Automotives /","MotorBikes")}
          <input
