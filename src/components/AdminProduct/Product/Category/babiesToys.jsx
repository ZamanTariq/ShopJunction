...
export default class babiesToys extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentWillMount() {
    fetch("http://localhost:5000/adminproduct/category/babies-toys")
  ...
  render() {
    ...
    return (
      <div className="container-fluid">
        ...
        {Title (<MDBIcon icon="fas fa-dreidel" />,"Babies", " & Toys")}
          <input
