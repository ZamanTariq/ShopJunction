...
import Title from "../../../CategoryTitle";
...
class Deal extends Component {
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:5000/adminaddtocart', {
                ...
                <div className="card-body">
                  <h5 className="card-title mb-1 text-uppercase">
                    <strong style={{ fontSize: "0.8rem" }}>
                      <Link
                        to={"/admin-product-detail/" + this.props.deal._id}
...
export default class electronicAccessories extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentWillMount() {
    fetch("http://localhost:5000/adminproduct/category/electronic-accessories")
  ...
  render() {
    ...
    return (
      <div className="container-fluid">
        ...
        {Title (<MDBIcon icon="fas fa-plug"  />,"Electronic", "Accessories")}
          <input
