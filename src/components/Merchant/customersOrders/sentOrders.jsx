...
export default class sentOrder extends Component {
constructor(props){
  super(props)
  this.state = {
    collapsed: false,
...
componentDidMount(){
  axios.get('http://localhost:5000/deliverdOrder/merchant/'+this.getMerchantId())
    .then(response => {          
    ...
    render() {
      const data = {
        ...
        <Sider collapsible collapsed={this.state.collapsed} onCollapse={this.onCollapse}>
            <div className="text-center  font-weight-bold text-white py-4"><Link to="/merchant-shop">MERCAHNT</Link></div>
          <div  />
