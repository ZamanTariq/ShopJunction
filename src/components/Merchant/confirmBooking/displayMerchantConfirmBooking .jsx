...
import {AcceptBookingRequest} from '../../notificationMessages'
var dateFormat = require('dateformat');
const { Header, Content, Footer, Sider } = Layout;
const { SubMenu } = Menu;

export default class cofirmDisplayBooking extends Component {
constructor(props){
  super(props)
  this.state = {
    collapsed: false,
...
componentDidMount(){
  axios.get('http://localhost:5000/confirmBookings/merchant/'+this.getMerchantId())
    .then(response => {
