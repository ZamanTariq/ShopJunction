...
import { login } from "./Function/merchantFunction";
import styled from "styled-components";
import {successfullyLoginMerchant,invalidEmailPasswordError,fillAllFields} from '../notificationMessages'
...
export default class MerchantSignIn extends Component {
  constructor(props) {
    super(props);
    this.state = {
      email: "",
      ...
      <div className="container">
        <div className="row">
         ...
         <h6 className="font-weight-normal text-center text-uppercase mb-3">Sign In</h6>
              ...
              <Link to="/merchant-forget-password" className="text-center">Forgot password?</Link>
            </form>
          </div>
        </div>
      </div>
