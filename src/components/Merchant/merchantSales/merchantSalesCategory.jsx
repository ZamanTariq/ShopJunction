...
const { SubMenu } = Menu;
export default class MerchantSaleCategory extends Component {
constructor(props){
super(props)
this.state = {
collapsed: false,
...
componentDidMount() {
axios
.get("http://localhost:5000/deliverdOrder/merchantTotalbycategory/"+this.merchantId())
.then((res) => {
...
axios
.get("http://localhost:5000/deliverdOrder/total/"+this.merchantId())
.then((res) => {
...
<Wrapper>
   <div >
      ...
      <h3 className="font-weight-bold panel-title text-center text-uppercase "> Sale By Category</h3>
      </div>
