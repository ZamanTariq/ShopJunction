...
export default class AdminFavouriteProductList extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    axios
      .get("http://localhost:5000/adminFavourites/"+this.getUserId())
      .then(res => {
  ...
  handleDelete=favourite=> {
    ...
    axios.get('http://localhost:5000/adminFavourites/delete/'+favourite._id)
      ...
      return this.state.products.map(favourite => (
        ...
        <section >
            <div className="mb-2">
              ...
              <Link to={"/admin-product-detail/" +favourite.productId}>
