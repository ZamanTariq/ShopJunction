...
componentDidMount(){
  axios.get('http://localhost:5000/confirmBookings/'+this.getUserId())
    .then(response => {
  ...
  <div className="container cont">
    ...
    <div className="panel panel-default my-auto" id="transaction">
      ...
      <h3 className="font-weight-bold panel-title text-center text-uppercase ">Confirm Booking Request</h3>
