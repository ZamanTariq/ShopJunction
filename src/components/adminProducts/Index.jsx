...
export default class DisplayAdminProduct extends Component {
constructor(props){
  super(props)
  this.state = {
    collapsed: false,
...
componentDidMount() {
  axios
    .get("http://localhost:5000/adminproduct/")
    .then((res) => {
            ...
            action: (
              <React.Fragment>
                <Link
                  ...
                  to={"/edit-admin-product/" + products._id}
                  title="Edit"
                >
  ...
  <div className="container cont" >
    ...
    <div className="panel panel-default my-auto" id="transaction">
      <div className="panel-heading main-color-bg">
        <h3 className="panel-title text-center "><b>ADMIN PRODUCTS</b></h3>
      </div>
      ...
      <Link to={"/create-admin-product/"} className="btn btn-sm btn-primary" >
            ...
            <Link to={"/"} className="btn btn-sm btn-success" size="sm">
              <b>Home View</b>
            </Link>
            </div>
